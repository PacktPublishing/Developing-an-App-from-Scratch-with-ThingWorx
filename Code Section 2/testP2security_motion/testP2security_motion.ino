...
//Thingworx details
char ThingName[]= "IOTDEVICE1";
char ServiceName[]= "SetValue";
char Property1[] = "Ismotion";
char Property2[] = "Islight";
char Property3[] = "Light";
...
void loop() {
  ...
  delay(500);        // delay in between reads for stability
    ...
    //int l = 43;
     ...
     String k = "{\"Islight\":\""+String(sensorValue)+"\"}" ;
   // int h = l.length();
    Serial.println(k);
   ...
   String fullRequestURL2 = String(server) + "/Thingworx/Things/"+ ThingName +"/Properties/"+ Property2+"?appKey=" + String(APIKEY);
    ...
    int buttonState = digitalRead(pushButton);
       ...
       String i = "{\"Ismotion\":\""+String(buttonState)+"\"}" ;
   // int h = l.length();
    Serial.println(i);
